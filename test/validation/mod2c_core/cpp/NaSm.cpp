...
static void _update_global_variables(NrnThread *_nt, Memb_list *_ml) {
 ...
 #define Etemp static_cast<_global_variables_t*>(_ml->instance)->Etemp
 #define Vtm static_cast<_global_variables_t*>(_ml->instance)->Vtm
 #define Vsm static_cast<_global_variables_t*>(_ml->instance)->Vsm
 #define ena static_cast<_global_variables_t*>(_ml->instance)->ena
 #define ktm static_cast<_global_variables_t*>(_ml->instance)->ktm
 #define ksm static_cast<_global_variables_t*>(_ml->instance)->ksm
